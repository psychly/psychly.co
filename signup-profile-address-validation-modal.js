// Function to unhide the 'profile-address-valid-container'
  function unhideAddressContainer() {
    var container = document.getElementById('signup-profile-address-valid-container');
  ...
  function setupEventListeners() {
    ...
    document.getElementById('signup-confirm-address-button').addEventListener('click', unhideAddressContainer);
    ...
    var saveAddressButton = document.getElementById('signup-profile-save-address-button');
    if (saveAddressButton) {
      saveAddressButton.addEventListener('click', function() {
        ...
        var originalSubmitButton = document.getElementById('signup-address-submit-button-hidden') || document.querySelector('.original-submit-button-class');
